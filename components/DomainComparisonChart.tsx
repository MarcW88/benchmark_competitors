          ...
          return (
            <div key={s.domain} className="flex flex-col items-center gap-2 flex-1 min-w-0">
              ...
              <div className="w-full flex items-end" style={{ height: "160px" }}>
                <div
                  className={`w-full rounded-t-lg transition-all duration-500 ${color.bar}`}
                  style={{ height: `${Math.max(pct, 1)}%` }}
                />
              </div>
              <div className={`w-full text-center px-1 py-1 rounded-lg border text-xs font-medium truncate ${color.light}`}
                title={s.domain}>
